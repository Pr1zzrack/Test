...
class ProfileAdmin(admin.ModelAdmin):
    list_display = ('user', 'first_name', 'last_name', 'date_of_birth', 'gender')  # Поля для отображения в списке
    search_fields = ('user__email', 'first_name', 'last_name')  # Поиск по email пользователя и имени
